...
public class SpellDateUtil {
 static final int GB_SP_DIFF = 160;
    ...
    static final int[] secPosValueList = {1601, 1637, 1833, 2078, 2274, 2302,
        2433, 2594, 2787, 3106, 3212, 3472, 3635, 3722, 3730, 3858, 4027, 4086,
        4390, 4558, 4684, 4925, 5249, 5600};
    
    // 存放国标一级汉字不同读音的起始区位码对应读音
    static final char[] firstLetter = {'a', 'b', 'c', 'd', 'e', 'f', 'g', 'h',
        'j', 'k', 'l', 'm', 'n', 'o', 'p', 'q', 'r', 's', 't', 'w', 'x', 'y',
        'z'};
    ...
    public static String getSpells(String characters) {
        ...
        for (int i = 0; i < characters.length(); i++) {
            ...
            if ((ch >> 7) == 0) {
                buffer.append(characters.substring(0, 1));
    ...
    public static String getSpell(String characters){
    	String buffer ;
             ...
             if ((ch >> 7) == 0) {
            	 buffer = characters.substring(0, 1);
                 // 判断是否为汉字，如果左移7为为0就不是汉字，否则是汉字
             } else {
             	String[] pinyin = PinyinHelper.toHanyuPinyinStringArray(ch);
             	buffer = (pinyin[0]).substring(0, 1);
             }
