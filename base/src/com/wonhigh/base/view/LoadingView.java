	...
	private void init(Context paramContext) {
		...
		if (Build.VERSION.SDK_INT >= 16) {
			...
			localView.setBackgroundDrawable(localGradientDrawable);
				...
				int i = (int) (120.0F * f1);
//		int i = (int) (new Paint().measureText(msg) * f1);
		...
		RelativeLayout.LayoutParams localLayoutParams2 = new RelativeLayout.LayoutParams(LayoutParams.WRAP_CONTENT,
		...
		RelativeLayout.LayoutParams localLayoutParams3 = new RelativeLayout.LayoutParams(LayoutParams.WRAP_CONTENT,
				LayoutParams.WRAP_CONTENT);
